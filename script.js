window.onload=function()
{
    document.getElementById("userNameSubmit").addEventListener("click", async function(event) 
    {
        ...
        try
        {
            ...
            results+= "<h1>Welcome, " + json.username + "</h1>";
        ...
        try
        {
            ...
            stats += '<div id= "Solo" class= "gameType">Solo Stats';
            ...
            stats += '<div id= "Duo" class= "gameType">Duo Stats';
            ...
            stats += '<div id= "Squad" class= "gameType">Squad Stats';
